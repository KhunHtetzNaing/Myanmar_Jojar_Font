...
Sub Activity_Create(FirstTime As Boolean)
	...
	lb.Text = "	ပထမဦးစြာ Install ကိုႏွိပ္ျပီး Myanmar Jojar(iFont) ကို Install လုပ္ေပးလိုက္ပါ။  Install လုပ္လို့ၿပီးရင္ Done ကိုသာနွိပ္ေပးပါ။ ျပီးရင္ေအာက္ပါ Change Font ကိုနွိပ္ျပီး Myanmar Jojar(iFont) ကိုေရြးေပးလိုက္ပါ။"
