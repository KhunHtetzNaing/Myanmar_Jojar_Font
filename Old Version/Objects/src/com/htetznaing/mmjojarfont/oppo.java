...
public class oppo extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmjojarfont", "com.htetznaing.mmjojarfont.oppo");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmjojarfont", "com.htetznaing.mmjojarfont.oppo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmjojarfont.oppo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setText((Object)("	ပထမဦးစြာ Install ကိုႏွိပ္ျပီး Myanmar Jojar(iFont) ကို Install လုပ္ေပးလိုက္ပါ။  Install လုပ္လို့ၿပီးရင္ Done ကိုသာနွိပ္ေပးပါ။ ျပီးရင္ေအာက္ပါ Change Font ကိုနွိပ္ျပီး Myanmar Jojar(iFont) ကိုေရြးေပးလိုက္ပါ။"));
...
mostCurrent._tlb.setText((Object)("Oppo"));
 //BA.debugLineNum = 66;BA.debugLine="tlb.Color = Colors.rgb(233, 30, 99)";
...
mostCurrent._banner.LoadAd();
 //BA.debugLineNum = 109;BA.debugLine="Interstitial.Initialize(\"Interstitial\",\"ca-app-pu";
mostCurrent._interstitial.Initialize(mostCurrent.activityBA,"Interstitial","ca-app-pub-4173348573252986/6173171758");
 //BA.debugLineNum = 110;BA.debugLine="Interstitial.LoadAd";
mostCurrent._interstitial.LoadAd();
 //BA.debugLineNum = 112;BA.debugLine="ad1.Initialize(\"ad1\",100)";
_ad1.Initialize(processBA,"ad1",(long) (100));
 //BA.debugLineNum = 113;BA.debugLine="ad1.Enabled = False";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 114;BA.debugLine="ad2.Initialize(\"ad2\",60000)";
_ad2.Initialize(processBA,"ad2",(long) (60000));
 //BA.debugLineNum = 115;BA.debugLine="ad2.Enabled = True";
...
public static String  _ad1_tick() throws Exception{
 //BA.debugLineNum = 155;BA.debugLine="Sub ad1_Tick";
...
mostCurrent._interstitial.Show();};
 //BA.debugLineNum = 157;BA.debugLine="ad1.Enabled = False";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 158;BA.debugLine="End Sub";
return "";
}
public static String  _ad2_tick() throws Exception{
 //BA.debugLineNum = 164;BA.debugLine="Sub ad2_Tick";
...
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 120;BA.debugLine="File.Copy(File.DirAssets,\"Jojar.apk\",File.DirRoot";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Jojar.apk",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Jojar.apk");
 //BA.debugLineNum = 121;BA.debugLine="Msgbox(\"1. Install Fone App\" & CRLF & \"2. After I";
anywheresoftware.b4a.keywords.Common.Msgbox("1. Install Fone App"+anywheresoftware.b4a.keywords.Common.CRLF+"2. After Installed click done!"+anywheresoftware.b4a.keywords.Common.CRLF+"3. Click Change Font and Choose your Font!","Attention!",mostCurrent.activityBA);
 //BA.debugLineNum = 122;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 123;BA.debugLine="i.Initialize(i.ACTION_VIEW,\"file:///\"&File.DirRoo";
_i.Initialize(_i.ACTION_VIEW,"file:///"+anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Jojar.apk");
 //BA.debugLineNum = 124;BA.debugLine="i.SetType(\"application/vnd.android.package-archiv";
...
anywheresoftware.b4a.objects.IntentWrapper _abc = null;
 ...
 //BA.debugLineNum = 129;BA.debugLine="If File.Exists(File.DirRootExternal,\"Jojar.apk\")";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Jojar.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 130;BA.debugLine="File.Delete(File.DirRootExternal,\"Jojar.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Jojar.apk");
 };
 //BA.debugLineNum = 132;BA.debugLine="Try";
try { //BA.debugLineNum = 133;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 134;BA.debugLine="i.Initialize(\"\", \"\")";
_i.Initialize("","");
 //BA.debugLineNum = 135;BA.debugLine="i.SetComponent(\"com.android.settings/.flipfont.F";
_i.SetComponent("com.android.settings/.flipfont.FontListActivity");
 //BA.debugLineNum = 136;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 } 
       catch (Exception e10) {
			processBA.setLastException(e10); //BA.debugLineNum = 138;BA.debugLine="Dim abc As Intent";
_abc = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 139;BA.debugLine="abc.Initialize(\"android.settings.DISPLAY_SETTING";
_abc.Initialize("android.settings.DISPLAY_SETTINGS","");
 //BA.debugLineNum = 140;BA.debugLine="StartActivity(abc)";
...
public static String  _b3_click() throws Exception{
 //BA.debugLineNum = 144;BA.debugLine="Sub b3_Click";
 //BA.debugLineNum = 145;BA.debugLine="If File.Exists(File.DirRootExternal,\"Jojar.apk\")";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Jojar.apk")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 146;BA.debugLine="File.Delete(File.DirRootExternal,\"Jojar.apk\")";
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Jojar.apk");
 };
 //BA.debugLineNum = 148;BA.debugLine="StartActivity(Tutorial)";
...
public static String  _menu_click() throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub menu_Click";
 //BA.debugLineNum = 207;BA.debugLine="If sm.isVisible Then sm.Hide Else sm.Show";
...
anywheresoftware.b4a.objects.IntentWrapper _shareit = null;
 //BA.debugLineNum = 210;BA.debugLine="Sub share_Click";
 //BA.debugLineNum = 211;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 212;BA.debugLine="copy.clrText";
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 213;BA.debugLine="copy.setText(\"#Myanmar_Jojar_Font App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Jojar_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://bit.ly/2mqSEWy");
 //BA.debugLineNum = 214;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 215;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 216;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 217;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT\",";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 218;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\")";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 219;BA.debugLine="StartActivity (ShareIt)";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 173;BA.debugLine="Sub SlideMenu_Click(Item As Object)";
 //BA.debugLineNum = 174;BA.debugLine="sm.Hide";
mostCurrent._sm._hide();
 //BA.debugLineNum = 175;BA.debugLine="Select Item";
switch (BA.switchObjectToInt(_item,(Object)(1),(Object)(2),(Object)(3),(Object)(4),(Object)(5),(Object)(6),(Object)(7),(Object)(8),(Object)(9))) {
case 0: {
 //BA.debugLineNum = 177;BA.debugLine="StartActivity(Samsung)";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 191;BA.debugLine="copy.setText(\"#Myanmar_Jojar_Font App! Beautifu";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Jojar_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://bit.ly/2mqSEWy");
...
_shareit.SetType("text/plain");
 //BA.debugLineNum = 194;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",c";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
...
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_shareit.getObject()));
 break; }
case 7: {
 //BA.debugLineNum = 199;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 200;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.htetzna";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_p.OpenBrowser("http://www.htetznaing.com")));
 break; }
case 8: {
 //BA.debugLineNum = 202;BA.debugLine="StartActivity(About)";
