...
public class tutorial extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmjojarfont", "com.htetznaing.mmjojarfont.tutorial");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmjojarfont", "com.htetznaing.mmjojarfont.tutorial");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmjojarfont.tutorial", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._tlb.setText((Object)("Tutorial"));
 //BA.debugLineNum = 28;BA.debugLine="tlb.Color = Colors.rgb(233, 30, 99)";
...
mostCurrent._banner.LoadAd();
 //BA.debugLineNum = 48;BA.debugLine="lb.Initialize(\"lb\")";
mostCurrent._lb.Initialize(mostCurrent.activityBA,"lb");
 //BA.debugLineNum = 49;BA.debugLine="lb.SetBackgroundImage(LoadBitmap(File.DirAssets,\"";
mostCurrent._lb.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"open.png").getObject()));
 //BA.debugLineNum = 50;BA.debugLine="Activity.AddView(lb,100%x - 40dip,12.5dip,30dip,3";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 53;BA.debugLine="Sub lb_Click";
 //BA.debugLineNum = 54;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 55;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.htetznain";
