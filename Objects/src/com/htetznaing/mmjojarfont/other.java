package com.htetznaing.mmjojarfont;
...
public class other extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmjojarfont", "com.htetznaing.mmjojarfont.other");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmjojarfont", "com.htetznaing.mmjojarfont.other");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmjojarfont.other", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public com.htetznaing.mmjojarfont.slidemenu _sm = null;
...
public com.htetznaing.mmjojarfont.main _main = null;
public com.htetznaing.mmjojarfont.main2 _main2 = null;
public com.htetznaing.mmjojarfont.samsung _samsung = null;
public com.htetznaing.mmjojarfont.oppo _oppo = null;
public com.htetznaing.mmjojarfont.huawei _huawei = null;
public com.htetznaing.mmjojarfont.vivo _vivo = null;
public com.htetznaing.mmjojarfont.tutorial _tutorial = null;
public com.htetznaing.mmjojarfont.about _about = null;
public com.htetznaing.mmjojarfont.xiaomi _xiaomi = null;
...
mostCurrent._tlb.setText((Object)("Other [#Root]"));
 //BA.debugLineNum = 112;BA.debugLine="tlb.Color = Colors.rgb(233, 30, 99)";
mostCurrent._tlb.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (233),(int) (30),(int) (99)));
...
mostCurrent._banner.Initialize2(mostCurrent.activityBA,"Banner","ca-app-pub-4173348573252986/4696438557",mostCurrent._banner.SIZE_SMART_BANNER);
...
mostCurrent._banner.LoadAd();
 //BA.debugLineNum = 155;BA.debugLine="Interstitial.Initialize(\"Interstitial\",\"ca-app-pu";
...
mostCurrent._interstitial.LoadAd();
 //BA.debugLineNum = 158;BA.debugLine="ad1.Initialize(\"ad1\",100)";
...
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 160;BA.debugLine="ad2.Initialize(\"ad2\",60000)";
_ad2.Initialize(processBA,"ad2",(long) (60000));
 //BA.debugLineNum = 161;BA.debugLine="ad2.Enabled = True";
_ad2.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 163;BA.debugLine="ti.Initialize(\"ti\",100)";
_ti.Initialize(processBA,"ti",(long) (100));
 //BA.debugLineNum = 164;BA.debugLine="ti.Enabled = False";
_ti.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 165;BA.debugLine="tr.Initialize(\"tr\",100)";
_tr.Initialize(processBA,"tr",(long) (100));
 //BA.debugLineNum = 166;BA.debugLine="tr.Enabled = False";
_tr.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 168;BA.debugLine="ist.Initialize(\"ist\",5000)";
_ist.Initialize(processBA,"ist",(long) (5000));
 //BA.debugLineNum = 169;BA.debugLine="ist.Enabled = False";
_ist.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 170;BA.debugLine="rst.Initialize(\"rst\",5000)";
_rst.Initialize(processBA,"rst",(long) (5000));
 //BA.debugLineNum = 171;BA.debugLine="rst.Enabled = False";
...
anywheresoftware.b4a.phone.PackageManagerWrapper _pm = null;
 //BA.debugLineNum = 586;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
 //BA.debugLineNum = 587;BA.debugLine="Dim in As Intent";
_in = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 588;BA.debugLine="Dim pm As PackageManager";
_pm = new anywheresoftware.b4a.phone.PackageManagerWrapper();
 //BA.debugLineNum = 589;BA.debugLine="in = pm.GetApplicationIntent(\"com.xinmei365.fonu\"";
_in = _pm.GetApplicationIntent("com.xinmei365.fonu");
 //BA.debugLineNum = 590;BA.debugLine="If in.IsInitialized Then";
if (_in.IsInitialized()) { 
 //BA.debugLineNum = 591;BA.debugLine="Dim ml As MLfiles";
mostCurrent._ml = new MLfiles.Fileslib.MLfiles();
 //BA.debugLineNum = 592;BA.debugLine="ml.rmrf(File.DirRootExternal & \"/.MyanmarHeartFo";
...
anywheresoftware.b4a.objects.IntentWrapper _in = null;
anywheresoftware.b4a.phone.PackageManagerWrapper _pm = null;
 //BA.debugLineNum = 563;BA.debugLine="Sub Activity_Resume";
 //BA.debugLineNum = 564;BA.debugLine="Dim in As Intent";
_in = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 565;BA.debugLine="Dim pm As PackageManager";
_pm = new anywheresoftware.b4a.phone.PackageManagerWrapper();
 //BA.debugLineNum = 566;BA.debugLine="in = pm.GetApplicationIntent(\"com.xinmei365.fonu\"";
_in = _pm.GetApplicationIntent("com.xinmei365.fonu");
 //BA.debugLineNum = 567;BA.debugLine="If in.IsInitialized Then";
if (_in.IsInitialized()) { 
 //BA.debugLineNum = 568;BA.debugLine="Dim ml As MLfiles";
mostCurrent._ml = new MLfiles.Fileslib.MLfiles();
 //BA.debugLineNum = 569;BA.debugLine="ml.rmrf(File.DirRootExternal & \"/.MyanmarHeartFo";
mostCurrent._ml.rmrf(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/.MyanmarHeartFont");
 };
...
public static String  _ad1_tick() throws Exception{
 //BA.debugLineNum = 573;BA.debugLine="Sub ad1_Tick";
...
mostCurrent._interstitial.Show();};
 //BA.debugLineNum = 575;BA.debugLine="ad1.Enabled = False";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 576;BA.debugLine="End Sub";
return "";
}
public static String  _ad2_tick() throws Exception{
 //BA.debugLineNum = 582;BA.debugLine="Sub ad2_Tick";
 //BA.debugLineNum = 583;BA.debugLine="If Interstitial.Ready Then Interstitial.Show";
if (mostCurrent._interstitial.getReady()) { 
mostCurrent._interstitial.Show();};
...
public static String  _b1_click() throws Exception{
 //BA.debugLineNum = 174;BA.debugLine="Sub b1_Click";
 //BA.debugLineNum = 175;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 176;BA.debugLine="ml.GetRoot";
mostCurrent._ml.GetRoot();
 //BA.debugLineNum = 177;BA.debugLine="If ml.HaveRoot Then";
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 178;BA.debugLine="File.Copy(File.DirAssets,\"Jojar.ttf\",File.DirRoo";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Jojar.ttf",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"MyanmarHeart.ttf");
 //BA.debugLineNum = 179;BA.debugLine="ProgressDialogShow(\"Installing...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Installing...");
 //BA.debugLineNum = 180;BA.debugLine="ti.Enabled = True";
_ti.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 182;BA.debugLine="Msgbox(\"Your device not have Root Access!\",\"Atte";
...
public static String  _b2_click() throws Exception{
 //BA.debugLineNum = 416;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 417;BA.debugLine="ml.GetRoot";
mostCurrent._ml.GetRoot();
 //BA.debugLineNum = 418;BA.debugLine="If ml.HaveRoot Then";
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 419;BA.debugLine="ProgressDialogShow(\"Please Wait...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,"Please Wait...");
 //BA.debugLineNum = 420;BA.debugLine="tr.Enabled = True";
_tr.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 422;BA.debugLine="Msgbox(\"Your device not have Root Access!\",\"Atte";
anywheresoftware.b4a.keywords.Common.Msgbox("Your device not have Root Access!","Attention!",mostCurrent.activityBA);
 };
...
public static String  _b3_click() throws Exception{
 //BA.debugLineNum = 559;BA.debugLine="Sub b3_Click";
 //BA.debugLineNum = 560;BA.debugLine="StartActivity(Tutorial)";
...
mostCurrent._sm = new com.htetznaing.mmjojarfont.slidemenu();
...
mostCurrent._lw = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Dim mm As Typeface : mm = mm.LoadFromAssets(\"Joja";
...
public static String  _interstitial_adclosed() throws Exception{
 //BA.debugLineNum = 578;BA.debugLine="Sub Interstitial_AdClosed";
 //BA.debugLineNum = 579;BA.debugLine="Interstitial.LoadAd";
mostCurrent._interstitial.LoadAd();
 //BA.debugLineNum = 580;BA.debugLine="End Sub";
return "";
}
public static String  _ist_tick() throws Exception{
 //BA.debugLineNum = 406;BA.debugLine="Sub ist_Tick";
 //BA.debugLineNum = 407;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 408;BA.debugLine="Msgbox(\"Congratulations! Myanmar Installed in you";
...
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 411;BA.debugLine="ml.RootCmd(\"reboot\",\"\",Null,Null,False)";
mostCurrent._ml.RootCmd("reboot","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 413;BA.debugLine="ist.Enabled = False";
_ist.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 414;BA.debugLine="End Sub";
return "";
}
public static String  _menu_click() throws Exception{
 //BA.debugLineNum = 630;BA.debugLine="Sub menu_Click";
 //BA.debugLineNum = 631;BA.debugLine="If sm.isVisible Then sm.Hide Else sm.Show";
...
public static String  _rst_tick() throws Exception{
 //BA.debugLineNum = 547;BA.debugLine="Sub rst_Tick";
 //BA.debugLineNum = 548;BA.debugLine="ml.GetRoot";
mostCurrent._ml.GetRoot();
 //BA.debugLineNum = 549;BA.debugLine="If ml.HaveRoot Then";
if (mostCurrent._ml.HaveRoot) { 
 //BA.debugLineNum = 550;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 551;BA.debugLine="Msgbox(\"Congratulations! Original Restored\" & CR";
anywheresoftware.b4a.keywords.Common.Msgbox("Congratulations! Original Restored"+anywheresoftware.b4a.keywords.Common.CRLF+"Now, your device will be reboot!","Completed",mostCurrent.activityBA);
 //BA.debugLineNum = 552;BA.debugLine="ml.RootCmd(\"reboot\",\"\",Null,Null,False)";
mostCurrent._ml.RootCmd("reboot","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 554;BA.debugLine="Msgbox(\"Your device not have Root Access!\",\"Atte";
anywheresoftware.b4a.keywords.Common.Msgbox("Your device not have Root Access!","Attention!",mostCurrent.activityBA);
 };
 //BA.debugLineNum = 556;BA.debugLine="rst.Enabled = False";
_rst.setEnabled(anywheresoftware.b4a.keywords.Common.False);
...
anywheresoftware.b4a.objects.IntentWrapper _shareit = null;
 //BA.debugLineNum = 634;BA.debugLine="Sub share_Click";
 //BA.debugLineNum = 635;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 636;BA.debugLine="copy.clrText";
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 637;BA.debugLine="copy.setText(\"#Myanmar_Jojar_Font App! Beautiful";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Jojar_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://bit.ly/2mqSEWy");
 //BA.debugLineNum = 638;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 639;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 640;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 641;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT\",";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 642;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\")";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 643;BA.debugLine="StartActivity (ShareIt)";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 597;BA.debugLine="Sub SlideMenu_Click(Item As Object)";
 //BA.debugLineNum = 598;BA.debugLine="sm.Hide";
mostCurrent._sm._hide();
 //BA.debugLineNum = 599;BA.debugLine="Select Item";
switch (BA.switchObjectToInt(_item,(Object)(1),(Object)(2),(Object)(3),(Object)(4),(Object)(5),(Object)(6),(Object)(7),(Object)(8),(Object)(9))) {
case 0: {
 //BA.debugLineNum = 601;BA.debugLine="StartActivity(Me)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,other.getObject());
 break; }
case 1: {
 //BA.debugLineNum = 603;BA.debugLine="StartActivity(Oppo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._oppo.getObject()));
 break; }
case 2: {
 //BA.debugLineNum = 605;BA.debugLine="StartActivity(Vivo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._vivo.getObject()));
 break; }
case 3: {
 //BA.debugLineNum = 607;BA.debugLine="StartActivity(Huawei)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._huawei.getObject()));
 break; }
case 4: {
 //BA.debugLineNum = 609;BA.debugLine="StartActivity(Xiaomi)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._xiaomi.getObject()));
 break; }
case 5: {
 //BA.debugLineNum = 611;BA.debugLine="StartActivity(Me)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,other.getObject());
 break; }
case 6: {
 //BA.debugLineNum = 613;BA.debugLine="Dim ShareIt As Intent";
_shareit = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 614;BA.debugLine="copy.clrText";
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 615;BA.debugLine="copy.setText(\"#Myanmar_Jojar_Font App! Beautifu";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Jojar_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://bit.ly/2mqSEWy");
 //BA.debugLineNum = 616;BA.debugLine="ShareIt.Initialize (ShareIt.ACTION_SEND,\"\")";
_shareit.Initialize(_shareit.ACTION_SEND,"");
 //BA.debugLineNum = 617;BA.debugLine="ShareIt.SetType (\"text/plain\")";
_shareit.SetType("text/plain");
 //BA.debugLineNum = 618;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",c";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(mostCurrent._copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 619;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT";
_shareit.PutExtra("android.intent.extra.SUBJECT",(Object)("Get Free!!"));
 //BA.debugLineNum = 620;BA.debugLine="ShareIt.WrapAsIntentChooser(\"Share App Via...\")";
_shareit.WrapAsIntentChooser("Share App Via...");
 //BA.debugLineNum = 621;BA.debugLine="StartActivity (ShareIt)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_shareit.getObject()));
 break; }
case 7: {
 //BA.debugLineNum = 623;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 624;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.htetzna";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_p.OpenBrowser("http://www.htetznaing.com")));
 break; }
case 8: {
 //BA.debugLineNum = 626;BA.debugLine="StartActivity(About)";
...
public static String  _ti_tick() throws Exception{
 //BA.debugLineNum = 186;BA.debugLine="Sub ti_Tick";
 //BA.debugLineNum = 187;BA.debugLine="ml.RootCmd(\"mount -o rw,remount /system\",\"\",Null,";
mostCurrent._ml.RootCmd("mount -o rw,remount /system","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 188;BA.debugLine="If ml.Exists(\"/system/Ht3tzN4ing.ttf\") = False Th";
if (mostCurrent._ml.Exists("/system/Ht3tzN4ing.ttf")==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 189;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /syst";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/Ht3tzN4ing.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 191;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk.ttf\") = True";
if (mostCurrent._ml.Exists("/system/fonts/Padauk.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 192;BA.debugLine="ml.mv(\"/system/fonts/Padauk.ttf\",\"/system/fonts";
mostCurrent._ml.mv("/system/fonts/Padauk.ttf","/system/fonts/Padauk.ttf.bak");
 //BA.debugLineNum = 193;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Padauk.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 194;BA.debugLine="ml.chmod(\"/system/fonts/Padauk.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Padauk.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 198;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk-book.ttf\") =";
if (mostCurrent._ml.Exists("/system/fonts/Padauk-book.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 199;BA.debugLine="ml.mv(\"/system/fonts/Padauk-book.ttf\",\"/system/";
mostCurrent._ml.mv("/system/fonts/Padauk-book.ttf","/system/fonts/Padauk-book.ttf.bak");
 //BA.debugLineNum = 200;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Padauk-book.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 201;BA.debugLine="ml.chmod(\"/system/fonts/Padauk-book.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Padauk-book.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 205;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk-bookbold.ttf\"";
if (mostCurrent._ml.Exists("/system/fonts/Padauk-bookbold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 206;BA.debugLine="ml.mv(\"/system/fonts/Padauk-bookbold.ttf\",\"/sys";
mostCurrent._ml.mv("/system/fonts/Padauk-bookbold.ttf","/system/fonts/Padauk-bookbold.ttf.bak");
 //BA.debugLineNum = 207;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Padauk-bookbold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 208;BA.debugLine="ml.chmod(\"/system/fonts/Padauk-bookbold.ttf\",64";
mostCurrent._ml.chmod("/system/fonts/Padauk-bookbold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 212;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmar-Bold";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmar-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 213;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmar-Bold.ttf\",";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmar-Bold.ttf","/system/fonts/NotoSansMyanmar-Bold.ttf.bak");
 //BA.debugLineNum = 214;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmar-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 215;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmar-Bold.tt";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmar-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 219;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmar-Regu";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmar-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 220;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmar-Regular.tt";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmar-Regular.ttf","/system/fonts/NotoSansMyanmar-Regular.ttf.bak");
 //BA.debugLineNum = 221;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmar-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 222;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmar-Regular";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmar-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 226;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarUI-Bo";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarUI-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 227;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarUI-Bold.ttf";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmarUI-Bold.ttf","/system/fonts/NotoSansMyanmarUI-Bold.ttf.bak");
 //BA.debugLineNum = 228;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarUI-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 229;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarUI-Bold.";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarUI-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 233;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarUI-Re";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarUI-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 234;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarUI-Regular.";
...
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarUI-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 236;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarUI-Regul";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarUI-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 241;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarZawgy";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 242;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarZawgyi-Bold";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf","/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf.bak");
 //BA.debugLineNum = 243;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
...
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarZawgyi-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 251;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarZawgyi-R";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 255;BA.debugLine="If ml.Exists(\"/system/fonts/SamsungMyanmar.ttf\")";
if (mostCurrent._ml.Exists("/system/fonts/SamsungMyanmar.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 256;BA.debugLine="ml.mv(\"/system/fonts/SamsungMyanmar.ttf\",\"/syst";
mostCurrent._ml.mv("/system/fonts/SamsungMyanmar.ttf","/system/fonts/SamsungMyanmar.ttf.bak");
 //BA.debugLineNum = 257;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/SamsungMyanmar.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 258;BA.debugLine="ml.chmod(\"/system/fonts/SamsungMyanmar.ttf\",644";
mostCurrent._ml.chmod("/system/fonts/SamsungMyanmar.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 262;BA.debugLine="If ml.Exists(\"/system/fonts/ZawgyiOne.ttf\") = Tr";
if (mostCurrent._ml.Exists("/system/fonts/ZawgyiOne.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 263;BA.debugLine="ml.mv(\"/system/fonts/ZawgyiOne.ttf\",\"/system/fo";
...
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/ZawgyiOne.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 265;BA.debugLine="ml.chmod(\"/system/fonts/ZawgyiOne.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/ZawgyiOne.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 269;BA.debugLine="If ml.Exists(\"/system/fonts/ZawgyiOne2008.ttf\")";
if (mostCurrent._ml.Exists("/system/fonts/ZawgyiOne2008.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 270;BA.debugLine="ml.mv(\"/system/fonts/ZawgyiOne2008.ttf\",\"/syste";
mostCurrent._ml.mv("/system/fonts/ZawgyiOne2008.ttf","/system/fonts/ZawgyiOne2008.ttf.bak");
 //BA.debugLineNum = 271;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/ZawgyiOne2008.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 272;BA.debugLine="ml.chmod(\"/system/fonts/ZawgyiOne2008.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/ZawgyiOne2008.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 276;BA.debugLine="If ml.Exists(\"/system/fonts/mmsd.ttf\") = True Th";
if (mostCurrent._ml.Exists("/system/fonts/mmsd.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 277;BA.debugLine="ml.mv(\"/system/fonts/mmsd.ttf\",\"/system/fonts/m";
mostCurrent._ml.mv("/system/fonts/mmsd.ttf","/system/fonts/mmsd.ttf.bak");
 //BA.debugLineNum = 278;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/mmsd.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 279;BA.debugLine="ml.chmod(\"/system/fonts/mmsd.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/mmsd.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 283;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Regular.ttf\")";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 284;BA.debugLine="ml.mv(\"/system/fonts/Roboto-Regular.ttf\",\"/syst";
mostCurrent._ml.mv("/system/fonts/Roboto-Regular.ttf","/system/fonts/Roboto-Regular.ttf.bak");
 //BA.debugLineNum = 285;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Roboto-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 286;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Regular.ttf\",644";
mostCurrent._ml.chmod("/system/fonts/Roboto-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 289;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Light.ttf\") =";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Light.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 290;BA.debugLine="ml.mv(\"/system/fonts/Roboto-Light.ttf\",\"/system";
mostCurrent._ml.mv("/system/fonts/Roboto-Light.ttf","/system/fonts/Roboto-Light.ttf.bak");
 //BA.debugLineNum = 291;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Roboto-Light.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 292;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Light.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Light.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 295;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Bold.ttf\") =";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 296;BA.debugLine="ml.mv(\"/system/fonts/Roboto-Bold.ttf\",\"/system/";
mostCurrent._ml.mv("/system/fonts/Roboto-Bold.ttf","/system/fonts/Roboto-Bold.ttf.bak");
 //BA.debugLineNum = 297;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Roboto-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 298;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Bold.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 301;BA.debugLine="ist.Enabled = True";
_ist.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 302;BA.debugLine="ti.Enabled = False";
_ti.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 307;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk.ttf\") = True";
if (mostCurrent._ml.Exists("/system/fonts/Padauk.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 308;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Padauk.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 309;BA.debugLine="ml.chmod(\"/system/fonts/Padauk.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Padauk.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 313;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk-book.ttf\") =";
if (mostCurrent._ml.Exists("/system/fonts/Padauk-book.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 314;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Padauk-book.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 315;BA.debugLine="ml.chmod(\"/system/fonts/Padauk-book.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Padauk-book.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 319;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk-bookbold.ttf\"";
if (mostCurrent._ml.Exists("/system/fonts/Padauk-bookbold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 320;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Padauk-bookbold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 321;BA.debugLine="ml.chmod(\"/system/fonts/Padauk-bookbold.ttf\",64";
mostCurrent._ml.chmod("/system/fonts/Padauk-bookbold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 325;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmar-Bold";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmar-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 326;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmar-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 327;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmar-Bold.tt";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmar-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 331;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmar-Regu";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmar-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 332;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmar-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 333;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmar-Regular";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmar-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 337;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarUI-Bo";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarUI-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 338;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarUI-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 339;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarUI-Bold.";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarUI-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 343;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarUI-Re";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarUI-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 344;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarUI-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 345;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarUI-Regul";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarUI-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 350;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarZawgy";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 351;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarZawgyi-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 352;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarZawgyi-B";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 356;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarZawgy";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 357;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/NotoSansMyanmarZawgyi-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 358;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarZawgyi-R";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 362;BA.debugLine="If ml.Exists(\"/system/fonts/SamsungMyanmar.ttf\")";
if (mostCurrent._ml.Exists("/system/fonts/SamsungMyanmar.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 363;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/SamsungMyanmar.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 364;BA.debugLine="ml.chmod(\"/system/fonts/SamsungMyanmar.ttf\",644";
mostCurrent._ml.chmod("/system/fonts/SamsungMyanmar.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 368;BA.debugLine="If ml.Exists(\"/system/fonts/ZawgyiOne.ttf\") = Tr";
if (mostCurrent._ml.Exists("/system/fonts/ZawgyiOne.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 369;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/ZawgyiOne.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 370;BA.debugLine="ml.chmod(\"/system/fonts/ZawgyiOne.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/ZawgyiOne.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 374;BA.debugLine="If ml.Exists(\"/system/fonts/ZawgyiOne2008.ttf\")";
if (mostCurrent._ml.Exists("/system/fonts/ZawgyiOne2008.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 375;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/ZawgyiOne2008.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 376;BA.debugLine="ml.chmod(\"/system/fonts/ZawgyiOne2008.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/ZawgyiOne2008.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 380;BA.debugLine="If ml.Exists(\"/system/fonts/mmsd.ttf\") = True Th";
if (mostCurrent._ml.Exists("/system/fonts/mmsd.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 381;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/mmsd.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 382;BA.debugLine="ml.chmod(\"/system/fonts/mmsd.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/mmsd.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 386;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Regular.ttf\")";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Regular.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 387;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Roboto-Regular.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 388;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Regular.ttf\",644";
mostCurrent._ml.chmod("/system/fonts/Roboto-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 391;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Light.ttf\") =";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Light.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 392;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Roboto-Light.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 393;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Light.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Light.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 396;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Bold.ttf\") =";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Bold.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 397;BA.debugLine="ml.RootCmd(\"cp -r /sdcard/MyanmarHeart.ttf /sys";
mostCurrent._ml.RootCmd("cp -r /sdcard/MyanmarHeart.ttf /system/fonts/Roboto-Bold.ttf","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 398;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Bold.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 401;BA.debugLine="ist.Enabled = True";
_ist.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 402;BA.debugLine="ti.Enabled = False";
_ti.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 };
...
public static String  _tr_tick() throws Exception{
 //BA.debugLineNum = 426;BA.debugLine="Sub tr_Tick";
 //BA.debugLineNum = 427;BA.debugLine="ml.RootCmd(\"mount -o rw,remount /system\",\"\",Null,";
mostCurrent._ml.RootCmd("mount -o rw,remount /system","",(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),(java.lang.StringBuilder)(anywheresoftware.b4a.keywords.Common.Null),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 430;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk.ttf.bak\") = Tr";
if (mostCurrent._ml.Exists("/system/fonts/Padauk.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 431;BA.debugLine="ml.rm(\"/system/fonts/Padauk.ttf\")";
mostCurrent._ml.rm("/system/fonts/Padauk.ttf");
 //BA.debugLineNum = 432;BA.debugLine="ml.mv(\"/system/fonts/Padauk.ttf.bak\",\"/system/fo";
mostCurrent._ml.mv("/system/fonts/Padauk.ttf.bak","/system/fonts/Padauk.ttf");
 //BA.debugLineNum = 433;BA.debugLine="ml.chmod(\"/system/fonts/Padauk.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Padauk.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 437;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk-book.ttf.bak\")";
if (mostCurrent._ml.Exists("/system/fonts/Padauk-book.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 438;BA.debugLine="ml.rm(\"/system/fonts/Padauk-book.ttf\")";
mostCurrent._ml.rm("/system/fonts/Padauk-book.ttf");
 //BA.debugLineNum = 439;BA.debugLine="ml.mv(\"/system/fonts/Padauk-book.ttf.bak\",\"/syst";
mostCurrent._ml.mv("/system/fonts/Padauk-book.ttf.bak","/system/fonts/Padauk-book.ttf");
 //BA.debugLineNum = 440;BA.debugLine="ml.chmod(\"/system/fonts/Padauk-book.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Padauk-book.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 444;BA.debugLine="If ml.Exists(\"/system/fonts/Padauk-bookbold.ttf.b";
if (mostCurrent._ml.Exists("/system/fonts/Padauk-bookbold.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 445;BA.debugLine="ml.rm(\"/system/fonts/Padauk-bookbold.ttf\")";
mostCurrent._ml.rm("/system/fonts/Padauk-bookbold.ttf");
 //BA.debugLineNum = 446;BA.debugLine="ml.mv(\"/system/fonts/Padauk-bookbold.ttf.bak\",\"/";
mostCurrent._ml.mv("/system/fonts/Padauk-bookbold.ttf.bak","/system/fonts/Padauk-bookbold.ttf");
 //BA.debugLineNum = 447;BA.debugLine="ml.chmod(\"/system/fonts/Padauk-bookbold.ttf\",644";
mostCurrent._ml.chmod("/system/fonts/Padauk-bookbold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 451;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmar-Bold.";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmar-Bold.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 452;BA.debugLine="ml.rm(\"/system/fonts/NotoSansMyanmar-Bold.ttf\")";
mostCurrent._ml.rm("/system/fonts/NotoSansMyanmar-Bold.ttf");
 //BA.debugLineNum = 453;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmar-Bold.ttf.ba";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmar-Bold.ttf.bak","/system/fonts/NotoSansMyanmar-Bold.ttf");
 //BA.debugLineNum = 454;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmar-Bold.ttf";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmar-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 458;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmar-Regul";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmar-Regular.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 459;BA.debugLine="ml.rm(\"/system/fonts/NotoSansMyanmar-Regular.ttf";
mostCurrent._ml.rm("/system/fonts/NotoSansMyanmar-Regular.ttf");
 //BA.debugLineNum = 460;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmar-Regular.ttf";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmar-Regular.ttf.bak","/system/fonts/NotoSansMyanmar-Regular.ttf");
 //BA.debugLineNum = 461;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmar-Regular.";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmar-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 465;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarUI-Bol";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarUI-Bold.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 466;BA.debugLine="ml.rm(\"/system/fonts/NotoSansMyanmarUI-Bold.ttf\"";
mostCurrent._ml.rm("/system/fonts/NotoSansMyanmarUI-Bold.ttf");
 //BA.debugLineNum = 467;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarUI-Bold.ttf.";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmarUI-Bold.ttf.bak","/system/fonts/NotoSansMyanmarUI-Bold.ttf");
 //BA.debugLineNum = 468;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarUI-Bold.t";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarUI-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 472;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarUI-Reg";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarUI-Regular.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 473;BA.debugLine="ml.rm(\"/system/fonts/NotoSansMyanmarUI-Regular.t";
mostCurrent._ml.rm("/system/fonts/NotoSansMyanmarUI-Regular.ttf");
 //BA.debugLineNum = 474;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarUI-Regular.t";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmarUI-Regular.ttf.bak","/system/fonts/NotoSansMyanmarUI-Regular.ttf");
 //BA.debugLineNum = 475;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarUI-Regula";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarUI-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 479;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarZawgyi";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 480;BA.debugLine="ml.rm(\"/system/fonts/NotoSansMyanmarZawgyi-Bold.";
mostCurrent._ml.rm("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf");
 //BA.debugLineNum = 481;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarZawgyi-Bold.";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf.bak","/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf");
 //BA.debugLineNum = 482;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarZawgyi-Bo";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarZawgyi-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 486;BA.debugLine="If ml.Exists(\"/system/fonts/NotoSansMyanmarZawgyi";
if (mostCurrent._ml.Exists("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 487;BA.debugLine="ml.rm(\"/system/fonts/NotoSansMyanmarZawgyi-Regul";
mostCurrent._ml.rm("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf");
 //BA.debugLineNum = 488;BA.debugLine="ml.mv(\"/system/fonts/NotoSansMyanmarZawgyi-Regul";
mostCurrent._ml.mv("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf.bak","/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf");
 //BA.debugLineNum = 489;BA.debugLine="ml.chmod(\"/system/fonts/NotoSansMyanmarZawgyi-Re";
mostCurrent._ml.chmod("/system/fonts/NotoSansMyanmarZawgyi-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 493;BA.debugLine="If ml.Exists(\"/system/fonts/SamsungMyanmar.ttf.ba";
if (mostCurrent._ml.Exists("/system/fonts/SamsungMyanmar.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 494;BA.debugLine="ml.rm(\"/system/fonts/SamsungMyanmar.ttf\")";
mostCurrent._ml.rm("/system/fonts/SamsungMyanmar.ttf");
 //BA.debugLineNum = 495;BA.debugLine="ml.mv(\"/system/fonts/SamsungMyanmar.ttf.bak\",\"/s";
mostCurrent._ml.mv("/system/fonts/SamsungMyanmar.ttf.bak","/system/fonts/SamsungMyanmar.ttf");
 //BA.debugLineNum = 496;BA.debugLine="ml.chmod(\"/system/fonts/SamsungMyanmar.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/SamsungMyanmar.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 500;BA.debugLine="If ml.Exists(\"/system/fonts/ZawgyiOne.ttf.bak\") =";
if (mostCurrent._ml.Exists("/system/fonts/ZawgyiOne.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 501;BA.debugLine="ml.rm(\"/system/fonts/ZawgyiOne.ttf\")";
mostCurrent._ml.rm("/system/fonts/ZawgyiOne.ttf");
 //BA.debugLineNum = 502;BA.debugLine="ml.mv(\"/system/fonts/ZawgyiOne.ttf.bak\",\"/system";
mostCurrent._ml.mv("/system/fonts/ZawgyiOne.ttf.bak","/system/fonts/ZawgyiOne.ttf");
 //BA.debugLineNum = 503;BA.debugLine="ml.chmod(\"/system/fonts/ZawgyiOne.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/ZawgyiOne.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 507;BA.debugLine="If ml.Exists(\"/system/fonts/ZawgyiOne2008.ttf.bak";
if (mostCurrent._ml.Exists("/system/fonts/ZawgyiOne2008.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 508;BA.debugLine="ml.rm(\"/system/fonts/ZawgyiOne2008.ttf\")";
mostCurrent._ml.rm("/system/fonts/ZawgyiOne2008.ttf");
 //BA.debugLineNum = 509;BA.debugLine="ml.mv(\"/system/fonts/ZawgyiOne2008.ttf.bak\",\"/sy";
mostCurrent._ml.mv("/system/fonts/ZawgyiOne2008.ttf.bak","/system/fonts/ZawgyiOne2008.ttf");
 //BA.debugLineNum = 510;BA.debugLine="ml.chmod(\"/system/fonts/ZawgyiOne2008.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/ZawgyiOne2008.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 514;BA.debugLine="If ml.Exists(\"/system/fonts/mmsd.ttf.bak\") = True";
if (mostCurrent._ml.Exists("/system/fonts/mmsd.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 515;BA.debugLine="ml.rm(\"/system/fonts/mmsd.ttf\")";
mostCurrent._ml.rm("/system/fonts/mmsd.ttf");
 //BA.debugLineNum = 516;BA.debugLine="ml.mv(\"/system/fonts/mmsd.ttf.bak\",\"/system/font";
mostCurrent._ml.mv("/system/fonts/mmsd.ttf.bak","/system/fonts/mmsd.ttf");
 //BA.debugLineNum = 517;BA.debugLine="ml.chmod(\"/system/fonts/mmsd.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/mmsd.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 521;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Bold.ttf.bak\")";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Bold.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 522;BA.debugLine="ml.rm(\"/system/fonts/Roboto-Bold.ttf\")";
mostCurrent._ml.rm("/system/fonts/Roboto-Bold.ttf");
 //BA.debugLineNum = 523;BA.debugLine="ml.mv(\"/system/fonts/Roboto-Bold.ttf.bak\",\"/syst";
mostCurrent._ml.mv("/system/fonts/Roboto-Bold.ttf.bak","/system/fonts/Roboto-Bold.ttf");
 //BA.debugLineNum = 524;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Bold.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Bold.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 527;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Light.ttf.bak\"";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Light.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 528;BA.debugLine="ml.rm(\"/system/fonts/Roboto-Light.ttf\")";
mostCurrent._ml.rm("/system/fonts/Roboto-Light.ttf");
 //BA.debugLineNum = 529;BA.debugLine="ml.mv(\"/system/fonts/Roboto-Light.ttf.bak\",\"/sys";
mostCurrent._ml.mv("/system/fonts/Roboto-Light.ttf.bak","/system/fonts/Roboto-Light.ttf");
 //BA.debugLineNum = 530;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Light.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Light.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 533;BA.debugLine="If ml.Exists(\"/system/fonts/Roboto-Regular.ttf.ba";
if (mostCurrent._ml.Exists("/system/fonts/Roboto-Regular.ttf.bak")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 534;BA.debugLine="ml.rm(\"/system/fonts/Roboto-Regular.ttf\")";
mostCurrent._ml.rm("/system/fonts/Roboto-Regular.ttf");
 //BA.debugLineNum = 535;BA.debugLine="ml.mv(\"/system/fonts/Roboto-Regular.ttf.bak\",\"/s";
mostCurrent._ml.mv("/system/fonts/Roboto-Regular.ttf.bak","/system/fonts/Roboto-Regular.ttf");
 //BA.debugLineNum = 536;BA.debugLine="ml.chmod(\"/system/fonts/Roboto-Regular.ttf\",644)";
mostCurrent._ml.chmod("/system/fonts/Roboto-Regular.ttf",BA.NumberToString(644));
 };
 //BA.debugLineNum = 539;BA.debugLine="If ml.Exists(\"/system/Ht3tzN4ing.ttf\") = True The";
if (mostCurrent._ml.Exists("/system/Ht3tzN4ing.ttf")==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 540;BA.debugLine="ml.rm(\"/system/Ht3tzN4ing.ttf\")";
mostCurrent._ml.rm("/system/Ht3tzN4ing.ttf");
 };
 //BA.debugLineNum = 543;BA.debugLine="rst.Enabled = True";
_rst.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 544;BA.debugLine="tr.Enabled = False";
_tr.setEnabled(anywheresoftware.b4a.keywords.Common.False);
